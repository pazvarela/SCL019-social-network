...
export const Post = () => {
    ...
    btnAddPost.addEventListener("click", async(event) => {
        ...
        const publicationContent = document.querySelector("root");
        publicationContent.innerHTML = view;
        const newPublication = publicationContent.querySelector("#descrpTitle");
